...
#. Create a new ``values-<environment>.yaml`` file in `/environments <https://github.com/lsst-sqre/phalanx/tree/master/environments/>`__.
...
#. For each enabled application, create a corresponding ``values-<environment>.yaml`` file in the relevant directory under `/applications <https://github.com/lsst-sqre/phalanx/tree/master/applications/>`__.
