...
#. Update the ``appVersion`` field to the version of the new release in `/applications/tap-schema/Chart.yaml <https://github.com/lsst-sqre/phalanx/blob/main/applications/tap-schema/Chart.yaml>`__.
