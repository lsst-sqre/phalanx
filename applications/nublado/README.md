...
| controller.config.fsadmin.image.tag | string | `"8.13.0"` | Tag of fsadmin image to use |
...
| jupyterhub.hub.image.tag | string | `"8.13.0"` | Tag of image to use for JupyterHub |
