...
| config.tap | object | `{"schemaSourceTemplate":"https://github.com/lsst/sdm_schemas/archive/refs/tags/{version}.tar.gz","schemaVersion":"w.2025.49","servers":{"livetap":{"database":"livetap","databasePasswordKey":"livetap-database-password","databaseUser":"livetap","enabled":false,"schemas":["oga_live_obscore"]},"ssotap":{"database":"ssotap","databasePasswordKey":"ssotap-database-password","databaseUser":"ssotap","enabled":false,"schemas":["dp03_1yr","dp03_10yr"]},"tap":{"database":"tap","databasePasswordKey":"tap-database-password","databaseUser":"tap","enabled":false,"schemas":["dp02_dc2","dp1","ivoa_obscore"]}}}` | TAP schema management configuration |
