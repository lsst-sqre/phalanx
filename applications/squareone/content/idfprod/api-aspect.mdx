...
- DP1 [SIA](https://www.ivoa.net/documents/SIA/) (Simple Image Access) (v2): `https://data.lsst.cloud/api/sia/dp1/query`
...
- DP0.2 [SIA](https://www.ivoa.net/documents/SIA/) (Simple Image Access) (v2): `https://data.lsst.cloud/api/sia/dp02/query`
