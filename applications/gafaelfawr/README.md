...
| cloudsql.tolerations | list | Tolerate GKE amd64 and arm64 taints | Tolerations for the standalone Cloud SQL Proxy pod |
...
| maintenance.tolerations | list | Tolerate GKE amd64 and arm64 taints | Tolerations for Gafaelfawr maintenance and audit pods |
...
| operator.tolerations | list | Tolerate GKE amd64 and arm64 taints | Tolerations for the token management pod |
...
| redis-ephemeral.tolerations | list | Tolerate GKE amd64 and arm64 taints | Tolerations for the ephemeral Redis pod |
...
| redis.tolerations | list | Tolerate GKE amd64 and arm64 taints | Tolerations for the persistent Redis pod |
...
| tolerations | list | Tolerate GKE amd64 and arm64 taints | Tolerations for the Gafaelfawr frontend pod |
