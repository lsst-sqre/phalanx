...
![Version: 1.0.0](https://img.shields.io/badge/Version-1.0.0-informational?style=flat-square) ![AppVersion: 9.0.0](https://img.shields.io/badge/AppVersion-9.0.0-informational?style=flat-square)
...
| cloudsql.image.tag | string | `"1.33.4"` | Cloud SQL Auth Proxy tag to use |
