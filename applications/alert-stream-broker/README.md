...
| alert-stream-schema-registry.schemaSync | object | `{"image":{"repository":"lsstdm/lsst_alert_packet","tag":"tickets-DM-45209"},"subject":"alert-packet"}` | Configuration for the Job which injects the most recent alert_packet schema into the Schema Registry |
...
| alert-stream-schema-registry.schemaSync.image.tag | string | `"tickets-DM-45209"` | Version of the container to use |
