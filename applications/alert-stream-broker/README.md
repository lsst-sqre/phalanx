...
| alert-stream-broker.maxBytesRetained | string | `"10000000000000"` | Maximum number of bytes for the replay topic, per partition, per replica. Default is 100GB, but should be lower to not fill storage. |
