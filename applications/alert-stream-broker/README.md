...
| alert-stream-schema-registry.schemaSync | object | `{"image":{"digest":"sha256:9979a57878b93511e6fe4a19b90ff1a8341c7f83f46b7a8244fa824b26ce0f27","pullPolicy":"Always","repository":"lsstdm/lsst_alert_packet"},"subject":"alert-packet"}` | Configuration for the Job which injects the most recent alert_packet schema into the Schema Registry |
| alert-stream-schema-registry.schemaSync.image.digest | string | `"sha256:9979a57878b93511e6fe4a19b90ff1a8341c7f83f46b7a8244fa824b26ce0f27"` | Version of the container to use. If container isn't updating in Argo, switch to digest. tag: tickets-DM-42606 |
