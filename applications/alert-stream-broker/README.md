...
| alert-database.ingester.image.digest | string | `"sha256:ffbb2fb03f4147359a5945ecb4773a2ee3822614c00594ef0757de6061a22911"` |  |
...
| alert-database.server.image.tag | string | `"tickets-DM-59125"` |  |
