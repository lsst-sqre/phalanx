...
| schemaSync | object | `{"image":{"pullPolicy":"Always","repository":"lsstdm/lsst_alert_packet","tag":"tickets-DM-42606:<sha256:0ff9644298ce3371b36b8cc3a6f44026cda9a7e909a4882a862b5a688d722528>"},"subject":"alert-packet"}` | Configuration for the Job which injects the most recent alert_packet schema into the Schema Registry |
...
| schemaSync.image.tag | string | `"tickets-DM-42606:<sha256:0ff9644298ce3371b36b8cc3a6f44026cda9a7e909a4882a862b5a688d722528>"` | Version of the container to use |
