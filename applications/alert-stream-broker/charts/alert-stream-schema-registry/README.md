...
| schemaSync | object | `{"image":{"digest":"sha256:8f59fa56ade68297e494babb06a862e39c7d6aed478a90bb1bbd4dd4ce8fca74","pullPolicy":"Always","repository":"lsstdm/lsst_alert_packet"},"subject":"alert-packet"}` | Configuration for the Job which injects the most recent alert_packet schema into the Schema Registry |
| schemaSync.image.digest | string | `"sha256:8f59fa56ade68297e494babb06a862e39c7d6aed478a90bb1bbd4dd4ce8fca74"` | Version of the container to use tag: tickets-DM-42606 |
