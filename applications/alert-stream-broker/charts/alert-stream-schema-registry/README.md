...
| schemaSync | object | `{"image":{"repository":"lsstdm/lsst_alert_packet","tag":"tickets-DM-30267"},"subject":"alert-packet"}` | Configuration for the Job which injects the most recent alert_packet schema into the Schema Registry |
...
| schemaSync.image.tag | string | `"tickets-DM-30267"` | Version of the container to use |
