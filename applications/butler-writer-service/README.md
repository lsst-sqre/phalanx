...
| kafka.output_topic | string | None, must be set | Kafka topic where the Butler writer service will output information about ingested datasets, for consumption by the Prompt Publication Service. |
