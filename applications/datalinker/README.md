...
| config.tapMetadataUrl | string | `"https://github.com/lsst/sdm_schemas/releases/download/DP1-v1.1.3-rc1/datalink-columns.zip"` | URL containing TAP schema metadata used to construct queries |
