...
| ingress-nginx.controller.config.proxy-body-size | string | `"2g"` | Maximum size of the client request body (needs to be large enough to allow table uploads) |
...
| ingress-nginx.controller.image.digest | string | `"sha256:6c23471044041335807bcfb0cec22049ceb2d66f1cacf37033a42e3e75ad0f99"` |  |
| ingress-nginx.controller.image.digestChroot | string | `"sha256:ab9e75bd5aa26b383c4382b27a6957220e060974073c90cd0e1f8ff93bfbbc94"` |  |
...
| ingress-nginx.controller.image.tag | string | `"v1.15.6-lsstsqre-chainguard"` |  |
...
| ingress-nginx.controller.tolerations | list | Tolerate GKE amd64 and arm64 taints | Tolerations for the ingress-nginx-controller deployment pod |
