# prompt-processing-redis

Redis cluster for prompt processing

## Source Code

* <https://github.com/lsst-sqre/prompt-processing-redis>
...
| redis.config.secretName | string | `"prompt-processing-redis"` | Name of secret containing Redis password (do not change) |
