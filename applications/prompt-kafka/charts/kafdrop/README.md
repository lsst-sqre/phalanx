...
| cluster.name | string | `"prompt-kafka"` | Name of the Strimzi cluster. Synchronize this with the cluster name in the parent Sasquatch chart. |
...
| kafdrop.broker | string | `"prompt-kafka-kafka-bootstrap:9092"` | Kafka service with port. |
