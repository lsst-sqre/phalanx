...
Prompt Proto Service is an event driven service for processing camera images. This instance of the service handles LSSTComCamSim images.
...
| prompt-proto-service.instrument.skymap | string | `"DC2"` | Skymap to use with the instrument |
