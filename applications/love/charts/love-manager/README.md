...
| manager.frontend.env.REDIS_CONFIG_CAPACITY | int | `500` | The connection capacity for the redis service |
...
| manager.frontend.env.SHOW_TRACE_TIMESTAMPS | string | `"true"` | Whether to show timestamps in logs |
...
| manager.producers[0].env.REDIS_CONFIG_CAPACITY | int | `500` | The connection capacity for the redis service |
...
| manager.producers[0].topologySpreadConstraints | list | `[]` | Topology spread constraints for the LOVE manager producers pods |
...
| redis.image.tag | string | `"8.10.1"` | The tag to use for the redis image |
