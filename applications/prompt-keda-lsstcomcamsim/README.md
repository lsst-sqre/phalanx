# prompt-keda-lsstcomcamsim

KEDA Prompt Processing instance for LSSTComCamSim
...
| prompt-keda.s3.auth_env | bool | `false` | If set, get S3 credentials from this application's Vault secret and store in env vars. |
| prompt-keda.s3.checksum | string | `"WHEN_REQUIRED"` | If set, configure S3 checksum options. |
| prompt-keda.s3.cred_file_auth | bool | `true` | If set, get a S3 credential file from this application's Vault secret. |
