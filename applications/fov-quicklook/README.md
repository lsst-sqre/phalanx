...
| ccd_data_types | list | `[{"collections":["LSSTCam/raw/all"],"data_id_dimension":"exposure","display_name":"Raw","id":"raw","instrument":"LSSTCam","name":"raw","order_by":["-day_obs","-exposure"],"partial":false,"repository_name":"embargo"},{"collections":["LSSTCam/runs/nightlyValidation"],"data_id_dimension":"exposure","display_name":"Post-ISR","id":"post_isr_image","instrument":"LSSTCam","name":"post_isr_image","order_by":["-exposure"],"partial":true,"repository_name":"embargo"},{"collections":["LSSTCam/runs/nightlyValidation"],"data_id_dimension":"visit","display_name":"Preliminary","id":"preliminary_visit_image","instrument":"LSSTCam","name":"preliminary_visit_image","order_by":["-visit"],"partial":true,"repository_name":"embargo"}]` | CCD data type configurations for the quicklook system Each entry defines how to access different types of Butler data |
| ccd_data_types[0] | object | `{"collections":["LSSTCam/raw/all"],"data_id_dimension":"exposure","display_name":"Raw","id":"raw","instrument":"LSSTCam","name":"raw","order_by":["-day_obs","-exposure"],"partial":false,"repository_name":"embargo"}` | Raw data from LSSTCam |
| ccd_data_types[1] | object | `{"collections":["LSSTCam/runs/nightlyValidation"],"data_id_dimension":"exposure","display_name":"Post-ISR","id":"post_isr_image","instrument":"LSSTCam","name":"post_isr_image","order_by":["-exposure"],"partial":true,"repository_name":"embargo"}` | Post-ISR (Instrument Signature Removal) processed images |
| ccd_data_types[2] | object | `{"collections":["LSSTCam/runs/nightlyValidation"],"data_id_dimension":"visit","display_name":"Preliminary","id":"preliminary_visit_image","instrument":"LSSTCam","name":"preliminary_visit_image","order_by":["-visit"],"partial":true,"repository_name":"embargo"}` | Preliminary visit images |
