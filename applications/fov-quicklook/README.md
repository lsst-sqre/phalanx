...
| ccd_data_types | list | `[{"collections":["LSSTCam/raw/all"],"data_id_dimension":"exposure","display_name":"Raw (Embargo)","id":"raw-embargo","instrument":"LSSTCam","name":"raw-embargo","order_by":["-day_obs","-exposure"],"partial":false,"repository_name":"embargo"},{"collections":["LSSTCam/runs/nightlyValidation"],"data_id_dimension":"exposure","display_name":"Post-ISR (Embargo)","id":"post_isr_image-embargo","instrument":"LSSTCam","name":"post_isr_image-embargo","order_by":["-exposure"],"partial":true,"repository_name":"embargo"},{"collections":["LSSTCam/runs/nightlyValidation"],"data_id_dimension":"visit","display_name":"Preliminary (Embargo)","id":"preliminary_visit_image-embargo","instrument":"LSSTCam","name":"preliminary_visit_image-embargo","order_by":["-visit"],"partial":true,"repository_name":"embargo"},{"collections":["LSSTCam/raw/all"],"data_id_dimension":"exposure","display_name":"Raw (Main)","id":"raw-main","instrument":"LSSTCam","name":"raw-main","order_by":["-day_obs","-exposure"],"partial":false,"repository_name":"main"},{"collections":["LSSTCam/runs/nightlyValidation"],"data_id_dimension":"exposure","display_name":"Post-ISR (Main)","id":"post_isr_image-main","instrument":"LSSTCam","name":"post_isr_image-main","order_by":["-exposure"],"partial":true,"repository_name":"main"},{"collections":["LSSTCam/runs/nightlyValidation"],"data_id_dimension":"visit","display_name":"Preliminary (Main)","id":"preliminary_visit_image-main","instrument":"LSSTCam","name":"preliminary_visit_image-main","order_by":["-visit"],"partial":true,"repository_name":"main"}]` | CCD data type configurations for the quicklook system Each entry defines how to access different types of Butler data |
| ccd_data_types[0] | object | `{"collections":["LSSTCam/raw/all"],"data_id_dimension":"exposure","display_name":"Raw (Embargo)","id":"raw-embargo","instrument":"LSSTCam","name":"raw-embargo","order_by":["-day_obs","-exposure"],"partial":false,"repository_name":"embargo"}` | Embargo / Raw data from LSSTCam |
| ccd_data_types[1] | object | `{"collections":["LSSTCam/runs/nightlyValidation"],"data_id_dimension":"exposure","display_name":"Post-ISR (Embargo)","id":"post_isr_image-embargo","instrument":"LSSTCam","name":"post_isr_image-embargo","order_by":["-exposure"],"partial":true,"repository_name":"embargo"}` | Embargo / Post-ISR (Instrument Signature Removal) processed images |
| ccd_data_types[2] | object | `{"collections":["LSSTCam/runs/nightlyValidation"],"data_id_dimension":"visit","display_name":"Preliminary (Embargo)","id":"preliminary_visit_image-embargo","instrument":"LSSTCam","name":"preliminary_visit_image-embargo","order_by":["-visit"],"partial":true,"repository_name":"embargo"}` | Embargo / Preliminary visit images |
| ccd_data_types[3] | object | `{"collections":["LSSTCam/raw/all"],"data_id_dimension":"exposure","display_name":"Raw (Main)","id":"raw-main","instrument":"LSSTCam","name":"raw-main","order_by":["-day_obs","-exposure"],"partial":false,"repository_name":"main"}` | main / Raw data from LSSTCam |
| ccd_data_types[4] | object | `{"collections":["LSSTCam/runs/nightlyValidation"],"data_id_dimension":"exposure","display_name":"Post-ISR (Main)","id":"post_isr_image-main","instrument":"LSSTCam","name":"post_isr_image-main","order_by":["-exposure"],"partial":true,"repository_name":"main"}` | Post-ISR (Instrument Signature Removal) processed images |
| ccd_data_types[5] | object | `{"collections":["LSSTCam/runs/nightlyValidation"],"data_id_dimension":"visit","display_name":"Preliminary (Main)","id":"preliminary_visit_image-main","instrument":"LSSTCam","name":"preliminary_visit_image-main","order_by":["-visit"],"partial":true,"repository_name":"main"}` | Preliminary visit images |
