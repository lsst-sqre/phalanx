...
| ccd_data_types | list | `[{"collections":["LSSTCam/raw/all"],"data_id_dimension":"exposure","data_type":"raw","display_name":"Raw (Embargo)","instrument":"LSSTCam","order_by":["-day_obs","-exposure"],"partial":false,"repository_name":"embargo"},{"collections":["LSSTCam/runs/nightlyValidation"],"data_id_dimension":"exposure","data_type":"post_isr_image","display_name":"Post-ISR (Embargo)","instrument":"LSSTCam","order_by":["-exposure"],"partial":true,"repository_name":"embargo"},{"collections":["LSSTCam/runs/nightlyValidation"],"data_id_dimension":"visit","data_type":"preliminary_visit_image","display_name":"Preliminary (Embargo)","instrument":"LSSTCam","order_by":["-visit"],"partial":true,"repository_name":"embargo"}]` | CCD data type configurations for the quicklook system Each entry defines how to access different types of Butler data |
