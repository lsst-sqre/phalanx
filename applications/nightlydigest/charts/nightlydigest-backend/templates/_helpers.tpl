...
*/}}
{{- define "nightlydigest-backend.name" -}}
...
*/}}
{{- define "nightlydigest-backend.fullname" -}}
...
*/}}
{{- define "nightlydigest-backend.chart" -}}
...
Common labels
*/}}
{{- define "nightlydigest-backend.labels" -}}
helm.sh/chart: {{ include "nightlydigest-backend.chart" . }}
{{ include "nightlydigest-backend.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "nightlydigest-backend.selectorLabels" -}}
