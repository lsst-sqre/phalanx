...
| nightlydigest-backend.image.revision | int | `nil` | The cycle revision to add to the image tag. |
...
| nightlydigest-nginx.initContainers.frontend.image.revision | int | `nil` | The cycle revision to add to the image tag |
