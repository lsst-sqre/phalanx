...
|------------|------|---------|
|  | kafdrop | 1.0.0 |
|  | kafka-connect-manager(kafka-connect-manager) | 1.0.0 |
|  | source-kafka-connect-manager(kafka-connect-manager) | 1.0.0 |
|  | rest-proxy | 1.0.0 |
|  | square-events | 1.0.0 |
|  | strimzi-kafka | 1.0.0 |
|  | telegraf-kafka-consumer | 1.0.0 |
| https://helm.influxdata.com/ | chronograf | 1.2.5 |
| https://helm.influxdata.com/ | source-influxdb(influxdb) | 4.12.4 |
| https://helm.influxdata.com/ | influxdb(influxdb) | 4.12.4 |
| https://helm.influxdata.com/ | influxdb-staging(influxdb) | 4.12.4 |
