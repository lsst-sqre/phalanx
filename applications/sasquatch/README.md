...
| kapacitor.image | object | `{"repository":"kapacitor","tag":"1.7.0"}` | Kapacitor image tag. |
...
| source-kapacitor.image | object | `{"repository":"kapacitor","tag":"1.7.0"}` | Kapacitor image tag. |
