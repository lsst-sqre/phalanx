...
| rest-proxy.image.tag | string | `"7.6.1"` | Kafka REST proxy image tag |
...
| strimzi-kafka.kafka.disruptionTolerance | int | `1` | Number of down brokers that the system can tolerate |
