...
| chronograf.image | object | `{"repository":"quay.io/influxdb/chronograf","tag":"1.10.3"}` | Chronograf image tag. |
...
| rest-proxy.image.tag | string | `"7.6.0"` | Kafka REST proxy image tag. |
