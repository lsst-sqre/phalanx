...
| tma-ess121-sim.enabled | bool | `false` | Enable the ESS:1 simulator CSC |
| tma-ess121.enabled | bool | `false` | Enable the ESS:1 CSC |
| tma-ess122-sim.enabled | bool | `false` | Enable the ESS:2 simulator CSC |
| tma-ess122.enabled | bool | `false` | Enable the ESS:2 CSC |
