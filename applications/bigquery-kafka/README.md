...
| config.bigqueryMaxBytesBilled | string | None (no limit) | Maximum bytes that can be billed for a single BigQuery query. Queries exceeding this will fail. Set to null for no limit. |
