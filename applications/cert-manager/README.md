...
| cert-manager.cainjector.tolerations | list | Tolerate GKE amd64 and arm64 taints | Tolerations for the cert-manager cainjector pod |
...
| cert-manager.tolerations | list | Tolerate GKE amd64 and arm64 taints | Tolerations for the cert-manager controller |
...
| cert-manager.webhook.tolerations | list | Tolerate GKE amd64 and arm64 taints | Tolerations for the cert-manager webhook pod |
