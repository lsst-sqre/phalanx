...
| config.datalinkPayloadUrl | string | `"https://github.com/lsst/sdm_schemas/releases/download/v4.0.0rc1/datalink-snippets.zip"` | Datalink payload URL |
...
| tapSchema.image.tag | string | `"v4.0.0rc1"` | Tag of TAP schema image |
