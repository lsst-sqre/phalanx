...
| config.datalinkPayloadUrl | string | `"https://github.com/lsst/sdm_schemas/releases/download/2.6.0/datalink-snippets.zip"` | Datalink payload URL |
...
| tapSchema.image.tag | string | `"2.6.0"` | Tag of TAP schema image |
