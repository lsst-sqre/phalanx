...
| config.datalinkPayloadUrl | string | `"https://github.com/lsst/sdm_schemas/releases/download/DP1-v1.1.3-rc1/datalink-snippets.zip"` | Datalink payload URL |
...
| config.qserv.image.tag | string | `"3.4.1"` | Tag of TAP image to use |
...
| tapSchema.image.tag | string | `"DP1-v1.1.3-rc1"` | Tag of TAP schema image |
...
| uws.image.tag | string | `"3.4.1"` | Tag of UWS database image to use |
