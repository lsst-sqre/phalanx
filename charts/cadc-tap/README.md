...
| config.datalinkPayloadUrl | string | `"https://github.com/lsst/sdm_schemas/releases/download/w.2025.01/datalink-snippets.zip"` | Datalink payload URL |
...
| tapSchema.image.tag | string | `"w.2025.01"` | Tag of TAP schema image |
