...
| config.qserv.image.tag | string | `"3.4.0"` | Tag of TAP image to use |
...
| tapSchema.image.tag | string | `"tickets-DM-51562-ordering-test"` | Tag of TAP schema image |
...
| uws.image.tag | string | `"3.4.0"` | Tag of UWS database image to use |
