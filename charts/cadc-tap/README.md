...
| config.pg.image.tag | string | `"3.26.0"` | Tag of TAP image to use. |
...
| config.qserv.image.tag | string | `"3.26.0"` | Tag of TAP image to use |
...
| uws.image.tag | string | `"3.26.0"` | Tag of UWS database image to use |
