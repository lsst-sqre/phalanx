...
| config.qserv.image.tag | string | `"tickets-DM-49692"` | Tag of TAP image to use |
...
| tapSchema.image.tag | string | `"tickets-DM-51064-dp03-ssotimefix"` | Tag of TAP schema image |
