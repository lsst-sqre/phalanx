...
class ArgoCDStorage:
    ...
    def unset_helm_value(self, application: str, key: str) -> None:
    ...
    def list_applications(
        self, app_of_apps_name: str, exclude: frozenset[str]
    ) -> ApplicationList:
        ...
        app_of_apps_name
            Name of the parent app of apps.
        exclude
            Exclude these apps from the returned list.
        ...
        raw = [app for app in raw if app["metadata"]["name"] not in exclude]
        return ApplicationList.model_validate(raw)
