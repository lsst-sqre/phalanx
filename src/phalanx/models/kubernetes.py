...
class ConditionStatus(Enum):
    """Valid values for the condition.status field of a resource."""
...
class Resource(BaseModel):
    ...
    def is_ready(self) -> bool:
        ...
        -------
        bool
            True if this resource is ready.
        """
        if not self.status:
            return False
...
class PersistentVolume(Resource):
    """A PersistentVolume kubernetes resource."""
...
class Workload(NamespacedResource):
    ...
    """The number of replicas this workload manages."""
