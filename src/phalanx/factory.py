...
from phalanx.services.recovery_environment import RecoveryEnvironmentService
...
class Factory:
    ...
    def create_gke_recovery_service(
        ...
        *,
        ...
        gke_backup_service = self.create_gke_backup_service(
            region=gke_region,
            project=gke_project,
        ...
        return GKERecoveryService(
            ...
            gke_backup_service=gke_backup_service,
