...
![Version: 1.0.0](https://img.shields.io/badge/Version-1.0.0-informational?style=flat-square) ![AppVersion: 9.3.0](https://img.shields.io/badge/AppVersion-9.3.0-informational?style=flat-square)
...
|------------|------|---------|
| https://lsst-sqre.github.io/charts/ | redis | 1.0.6 |
...
| cloudsql.image.tag | string | `"1.33.8"` | Cloud SQL Auth Proxy tag to use |
