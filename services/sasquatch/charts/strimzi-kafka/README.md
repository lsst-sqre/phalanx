...
| mirrormaker2.source.bootstrapServer | string | `""` | Source (active) cluster bootstrap server. |
| mirrormaker2.target.bootstrapServer | string | `""` | Target (passive) cluster boostrap server. |
