...
| jupyterhub.hub.extraFiles."02_scopes.py".mountPath | string | `"/usr/local/etc/jupyterhub/jupyterhub_config.d/02_scopes.py"` |  |
| jupyterhub.hub.extraFiles."02_scopes.py".stringData | string | `"# Not sure why this isn't working from the config, but...\nc.JupyterHub.load_roles = [\n  {\n    'name': 'server',\n    'scopes': ['inherit'],\n  },\n  {\n    'name': 'self',\n    'scopes':  ['admin:servers!user', 'read:metrics'],\n  },\n  {\n    'name': 'jupyterhub-idle-culler-role',\n    'scopes': [\n      'list:users',\n      'read:users:activity',\n      'read:servers',\n      'delete:servers',\n      'admin:users', # if using --cull-users\n    ],\n    # assignment of role's permissions to:\n    'services': ['jupyterhub-idle-culler-service'],\n  },\n]\n"` |  |
